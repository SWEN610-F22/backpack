...
public class ProductControllerTest {
    ...
    public void getProducts() throws IOException {
        ...
        products[0] = new Product(1, "Fishing rod", "Can be used for fishing", 35.0, 10);
        products[1] = new Product(2, "Fishing rod 2", "Can be used for fishing", 35.0, 10);
    ...
    public void getProductsWithSearch() throws IOException {
        ...
        products[0] = new Product(1, "Fishing rod", "Can be used for fishing", 35.0, 10);
        products[1] = new Product(2, "Camping gear", "Can be used for gear", 5.0, 2);
        products[2] = new Product(3, "Hiking boots", "Can be used for boots", 13.0, 5);
